#!/bin/bash
# RecGPT baseline: same architecture as FET 8G+1Ex6 d=1536 but block 8 is GPT
# (softmax_attention) iterated 6× instead of EGPT energy descent. Math mix, ≥33B tokens.
...
CONFIG=${REPO}/configs/multi_block_ablation/math_recgpt_8gpt_1xg6_d1536_33b_16gpu.yml
SAVE_PATH=${REPO}/experiments/energy-inference/results/multi-block-ablation/math_recgpt_8gpt_1xg6_d1536_33b_16gpu
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_math_recgpt_8gpt_1xg6_d1536_33b_16gpu.sh
JOB_NAME=math_recgpt_8gpt1xg6_33b_16g
...
BSUB
echo "Submitted ${JOB_NAME} (16 GPU multi-node RecGPT 8G+1xG6 d=1536, normal grp_ebm, ≥33B tokens)"
