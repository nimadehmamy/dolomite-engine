#!/bin/bash
# reg_v1_egpt_12x1_d768_r16_lr2e3: register ablation experiment
set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=${REPO}/configs/multi_block_ablation/reg_v1_egpt_12x1_d768_r16_lr2e3.yml
SAVE_PATH=${REPO}/experiments/energy-inference/results/multi-block-ablation/reg_v1_egpt_12x1_d768_r16
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_reg_v1_egpt_12x1_d768_r16.sh
JOB_NAME=reg-v1-egpt-12x1-d768-r16
bsub \
