...
CONFIG=${REPO}/configs/multi_block_ablation/math_psda_h1_d1280_lra32_uni_4gpu.yml
SAVE_PATH=${REPO}/experiments/energy-inference/results/multi-block-ablation/math_psda_h1_d1280_lra32_uni_4gpu
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_math_psda_h1_d1280_lra32_uni_4gpu.sh
JOB_NAME=math_psda_h1_d1280_lra32_uni_4gpu
