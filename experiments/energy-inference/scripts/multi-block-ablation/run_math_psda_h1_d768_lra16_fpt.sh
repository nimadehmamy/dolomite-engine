...
CONFIG=${REPO}/configs/multi_block_ablation/math_psda_h1_d768_lra16_fpt.yml
SAVE_PATH=${REPO}/experiments/energy-inference/results/multi-block-ablation/math_psda_h1_d768_lra16_fpt
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_math_psda_h1_d768_lra16_fpt.sh
JOB_NAME=math_psda_h1_d768_lra16_fpt
