...
CONFIG=${REPO}/configs/multi_block_ablation/math_psda_h1_6gpt_1egpt6x_d1280.yml
SAVE_PATH=${REPO}/experiments/energy-inference/results/multi-block-ablation/math_psda_h1_6gpt_1egpt6x_d1280
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_math_psda_h1_6gpt_1egpt6x_d1280.sh
JOB_NAME=math_psda_h1_6gpt_1egpt6x_d1280
