...
# math_psda_h1_d1280_lra32_4gpu/ so it doesn't conflict with the 8-GPU run.
set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=${REPO}/configs/multi_block_ablation/math_psda_h1_d1280_lra32_4gpu.yml
SAVE_PATH=${REPO}/experiments/energy-inference/results/multi-block-ablation/math_psda_h1_d1280_lra32_4gpu
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_math_psda_h1_d1280_lra32_4gpu.sh
JOB_NAME=math_psda_h1_d1280_lra32_4gpu
