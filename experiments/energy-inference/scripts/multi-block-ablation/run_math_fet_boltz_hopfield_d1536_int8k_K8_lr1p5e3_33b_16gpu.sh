#!/bin/bash
# Boltzmann-MoE Hopfield FET 16 GPU big run. 8G+1Ex6 d=1536 with
...
TAG=math_fet_boltz_hopfield_8gpt_1egpt6x_d1536_int8k_K8_lra32_itd3_lr1p5e3_33b_16gpu
...
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_math_fet_boltz_hopfield_d1536_int8k_K8_lr1p5e3_33b_16gpu.sh
JOB_NAME=math_fet_bzhop_33b_16g
