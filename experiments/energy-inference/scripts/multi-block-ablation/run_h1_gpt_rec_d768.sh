...
CONFIG=${REPO}/configs/multi_block_ablation/h1_gpt_rec_d768.yml
SAVE_PATH=${REPO}/experiments/energy-inference/results/multi-block-ablation/h1_gpt_rec_d768
SCRIPT_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/scripts/multi-block-ablation/run_h1_gpt_rec_d768.sh
JOB_NAME=h1_gpt_rec_d768
