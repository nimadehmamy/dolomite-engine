#!/bin/bash
# 8-GPU single-node fallback for math_psda_h1_8gpt_1egpt6x_d1536_lra32_fpt.
# Normal queue / grp_ebm, matches the proven boltz 580M scheduling pattern.
# Same total tokens (126B), same effective batch (mb=4 ga=4 = 524k tok/step) as
# the 32-GPU run, 4× longer wall-clock.
# Save path is *_8gpu/ to keep separate.
set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=${REPO}/configs/multi_block_ablation/math_psda_h1_8gpt_1egpt6x_d1536_lra32_fpt_8gpu.yml
SAVE_PATH=${REPO}/experiments/energy-inference/results/multi-block-ablation/math_psda_h1_8gpt_1egpt6x_d1536_lra32_fpt_8gpu
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_math_psda_h1_8gpt_1egpt6x_d1536_lra32_fpt_8gpu.sh
JOB_NAME=math_h1_d1536_fpt_8g
...
BSUB
echo "Submitted ${JOB_NAME} (8 GPU single-node grp_ebm)"
