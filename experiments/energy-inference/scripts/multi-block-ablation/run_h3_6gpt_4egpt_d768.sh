...
CONFIG=${REPO}/configs/multi_block_ablation/h3_6gpt_4egpt_d768_lr2e3.yml
SAVE_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/results/multi-block-ablation/h3_6gpt_4egpt_d768
SCRIPT_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/scripts/multi-block-ablation/run_h3_6gpt_4egpt_d768.sh
JOB_NAME=h3_6gpt_4egpt_d768
bsub \
