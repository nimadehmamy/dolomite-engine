...
CONFIG=${REPO}/configs/multi_block_ablation/math_unc_sw_2g_1e6x_2g_d1280.yml
SAVE_PATH=${REPO}/experiments/energy-inference/results/multi-block-ablation/math_unc_sw_2g_1e6x_2g_d1280
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_math_unc_sw_2g_1e6x_2g_d1280.sh
JOB_NAME=math_unc_sw_2g_1e6x_2g_d1280
