#!/bin/bash
# reg_v73_6gpt_1egpt6x_d1280_r128: register ablation experiment
set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=${REPO}/configs/multi_block_ablation/reg_v73_6gpt_1egpt6x_d1280_r128.yml
SAVE_PATH=${REPO}/experiments/energy-inference/results/multi-block-ablation/reg_v73_6gpt_1egpt6x_d1280_r128
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_reg_v73_6gpt_1egpt6x_d1280_r128.sh
JOB_NAME=reg-v73-6gpt-1egpt6x-d1280-r12
bsub \
