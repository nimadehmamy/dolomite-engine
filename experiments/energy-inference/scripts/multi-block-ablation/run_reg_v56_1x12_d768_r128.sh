#!/bin/bash
# reg_v56_1x12_d768_r128_lr2e3: register ablation experiment
set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=${REPO}/configs/multi_block_ablation/reg_v56_1x12_d768_r128_lr2e3.yml
SAVE_PATH=${REPO}/experiments/energy-inference/results/multi-block-ablation/reg_v56_1x12_d768_r128
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_reg_v56_1x12_d768_r128.sh
JOB_NAME=reg-v56-1x12-d768-r128
bsub \
