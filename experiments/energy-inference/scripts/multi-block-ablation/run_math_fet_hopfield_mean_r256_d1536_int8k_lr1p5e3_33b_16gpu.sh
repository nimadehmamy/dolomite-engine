#!/bin/bash
# Hopfield-MEAN + r256 registers 16 GPU big run. 8G+1Ex6 d=1536 with Hopfield_Energy_MLP (single
...
TAG=math_fet_hopfield_mean_r256_8gpt_1egpt6x_d1536_int8k_lra32_itd3_lr1p5e3_33b_16gpu
...
SCRIPT_PATH=${REPO}/experiments/energy-inference/scripts/multi-block-ablation/run_math_fet_hopfield_mean_r256_d1536_int8k_lr1p5e3_33b_16gpu.sh
JOB_NAME=math_fet_hop_r256_33b_16g
